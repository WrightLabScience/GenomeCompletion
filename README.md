...
Folder: [Features_in_omitted_regions](Features_in_omitted_regions/) \
Related results: Figure 5B


## Investigating putative missing region by comparing k-mer counts between reads and assembly
Folder: [Missing_region_kmer_counts](Missing_region_kmer_counts/) \
